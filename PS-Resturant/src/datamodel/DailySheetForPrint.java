...
public class DailySheetForPrint {
...
//    public JFXButton showDetails = new JFXButton("التفاصيل");

    public DailySheetForPrint(int id, String actDate, String userName, String roomNum, String from, String to, float preDis, double tax, double service, float Dis, float inComeVal, String playing, String drink) {
        this.id = id;
        ...
        this.playing = workOnAllPlaying(playing);
